  ...
  return (
    <>
      <section className=" p-5  bg-primary">
        <h1 className="flex justify-center items-center text-center gap-2 text-4xl font-bold text-dark">
          Bienvenido a
      ...
      <section className="flex flex-col items-center justify-center p-10 gap-3 bg-blueish">
        <h2 className="text-5xl font-bold text-dark">Quieres conocer mas?</h2>
        <Link href="/inicio" className="rounded-full bg-primary hover:bg-secondary transform p-3">
          Cliqueame!
        </Link>
      </section>
